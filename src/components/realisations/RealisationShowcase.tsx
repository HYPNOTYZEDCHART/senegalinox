...
interface RealisationShowcaseProps {
  items: GalleryItem[];
...
export default function RealisationShowcase({
  items,
  categories,
  title = "Ouvrages & Réalisations",
  subtitle = "Explorez notre galerie d'équipements et d'installations conçus et posés par nos équipes au Sénégal et dans la sous-région.",
  badgeText = "Catalogue des Réalisations Réelles • Dakar & Sous-Région",
}: RealisationShowcaseProps) {
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-4">
            ...
            <p className="text-sm sm:text-base text-white/90 leading-relaxed max-w-2xl font-normal">
              Nos équipes d&apos;ingénierie et techniciens qualifiés étudient vos contraintes, réalisent les notes de calcul et plans d&apos;exécution, puis assurent la fabrication et l&apos;installation selon les normes les plus strictes.
            </p>
          </div>
